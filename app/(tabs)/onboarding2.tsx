...
import Button from '@/components/onboarding2/components/Button';
import Circle from '@/components/onboarding2/components/Circle';
import Background from '@/components/onboarding2/components/Background';
import RenderItem from '@/components/onboarding2/components/RenderItem';
import data from '@/components/onboarding2/data/data';
